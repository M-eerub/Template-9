...
export const menuItems: MenuItem[] = [
  ...
  {
    id: 'cheesy-grilled-pepperoni-sandwich',
  ...
  },
  {
    ...
    name: 'Fajita pasta with nuggets',
  ...
  {
    id: 'sausage-boat-sandwich',
    name: 'Sausage boat sandwich',
    ...
    calories: 260,
    priceRange: { min: 9, max: 15 },
    image: '/aqsa/starter menu/sausage-boat-sandwich.jpg',
    category: 'starter'
  },
  {
  ...
  {
    id: 'stuffed-chicken-strips',
    name: 'Stuffed chicken strips',
    description: 'Selection of Italian meats, cheeses, and marinated vegetables.',
    ingredients: ['Cured meats', 'Italian cheeses', 'Olives', 'Marinated vegetables', 'Crackers'],
    calories: 580,
    priceRange: { min: 16, max: 24 },
    image: '/aqsa/starter menu/stuffed-chicken-strips.jpg',
    category: 'starter'
  },
  ...
  },
  {
    ...
    calories: 780,
    priceRange: { min: 15, max: 22 },
    image: '/aqsa/main course/salad.jpg',
    category: 'main'
  },
  ...
  // Desserts (20 items)
  {
    ...
    calories: 580,
    priceRange: { min: 8, max: 14 },
    image: '/aqsa/desert/ice-cream.jpg',
    category: 'desert'
  },
  {
    id: 'fruit-custard',
    ...
    calories: 580,
    priceRange: { min: 8, max: 14 },
    image: '/aqsa/desert/fruit-custard.jpg',
    category: 'desert'
  },
  {
  ...
  // Drinks (20 items)
  {
    ...
    calories: 220,
    priceRange: { min: 9, max: 15 },
    image: '/aqsa/drink/orange-juice.jpg',
    category: 'drink'
  },
  {
    id: 'lime-juice',
    ...
    calories: 220,
    priceRange: { min: 9, max: 15 },
    image: '/aqsa/drink/lime.jpg',
    category: 'drink'
  },
  {
    id: 'Cocktails',
    name: 'Strawberry Cocktails',
    description: 'Premium tequila, fresh lime juice, and triple sec, served on the rocks.',
    ingredients: ['Tequila', 'Triple sec', 'Lime juice', 'Salt rim'],
    calories: 220,
    priceRange: { min: 9, max: 15 },
