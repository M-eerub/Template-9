...
const client = createClient({
  projectId: process.env.NEXT_PUBLIC_SANITY_PROJECT_ID='6d27jn9o',
  dataset: process.env.NEXT_PUBLIC_SANITY_DATASET='production',
  useCdn: false,
  token: process.env.SANITY_API_TOKEN='skS50NyoZezwlCqLplKfGScCgOR2RPHviWMVm4W5MtWwrjH4PCHYtJHiB0nbfyGqBGagkcdxRebvYHk3eXf5QDoWhCqgxmqOYDiqc5bPLdlFS0W3Co0Rkd9J7Oex4UpZ2DcEv9ww9mRWPm27Py6i3hWAibxdwRqCRzlACrqUVPZwSRmk0nfd',
